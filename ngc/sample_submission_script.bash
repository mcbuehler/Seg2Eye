...
LEARNING_RATE=$1 #default 0.0002 #0.0001 0.0002 0.0004 0.001
W_DIM=$2 #default 8 #8 16 32 64
STYLE_IMAGES=$3 #default 1 #7 11 15
COMBINE_MODE=$4 #default add #add seq
MEM=$5 #default 16 #16 32
...
EXPERIMENT+="_lr${LEARNING_RATE}"
EXPERIMENT+="_ns${STYLE_IMAGES}"
EXPERIMENT+="_cm-${COMBINE_MODE}"
...
CMD+="python3 train.py \
	...
	--lambda_l2 ${LAMBDA_L2} \
     --gsheet_secrets_json_file /root/gsheet.json \
     --gpu_ids 0,1,2,3,4,5,6,7 \
     --lr ${LEARNING_RATE} \
     --input_ns ${STYLE_IMAGES} \
...
NGC_CMD="ngc batch run \
	...
	--preempt RUNONCE \
	--ace nv-us-west-2 \
	--instance dgx1v.${MEM}g.8.norm \
	--image nvidian/lpr/shalini:OpenEDS \
	\
	--result /results \
